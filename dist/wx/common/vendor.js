...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_stateFood__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_stateFood___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__utils_stateFood__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utils_stateAchievement__ = __webpack_require__(86);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utils_stateAchievement___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__utils_stateAchievement__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utils_subject__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utils_subject___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__utils_subject__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__utils_wx_request__ = __webpack_require__(40);
...
var store = new __WEBPACK_IMPORTED_MODULE_3_vuex__["a" /* default */].Store({
    state: {
        ...
        foods: __WEBPACK_IMPORTED_MODULE_4__utils_stateFood___default.a.foodList,
        currFood: {}, // 当前选中的食物
        currGood: {}, // 当前收获的物品
        endDate: '', // 结束时间
        achievement: __WEBPACK_IMPORTED_MODULE_5__utils_stateAchievement___default.a.achievements,
        content: '', // 倒计时
        value: 0, // 进度条

        subjectList: __WEBPACK_IMPORTED_MODULE_6__utils_subject___default.a.subjects, // 学习题目
        currSubject: {}, // 当前关卡
    ...
    mutations: {
        SHOP_SETTLE: function SHOP_SETTLE(state, num) {
        ...
        //更改uid
        SAVE_UID: function SAVE_UID(state, uid) {
            state.user.uid = uid;
            console.log("uid......", state.user.uid);
        },
        //登录后设置用户id和name
        LOGIN_ID_NAME: function LOGIN_ID_NAME(state, val) {
            state.currId = val.id;
        ...
        //存档
        SAVE_GAME: function SAVE_GAME(state) {
            var achievement = state.achievement.map(function (obj) {
                return {
                    id: obj.id,
            ...
            wx.setStorageSync('farmDate', __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_json_stringify___default()(data));
            ...
            __WEBPACK_IMPORTED_MODULE_7__utils_wx_request__["a" /* default */].post_a({
        ...
        // 设置新用户名称
        SET_USER_NAME: function SET_USER_NAME(state, val) {
            state.user.name = val;
            state.user.money -= 1000;
        },
        SELL_GOOD: function SELL_GOOD(state, num) {
            ...
            if (state.currGood.num == 0) {
                // 出售完后删除
                state.goods.forEach(function (obj, index) {
        ...
        SHOW_GOOD: function SHOW_GOOD(state, name) {
            // 得到查看的物品
            state.goods.forEach(function (obj) {
                if (obj.name === name) {
                    state.currGood = obj;
                }
            });
        ...
        //获取收成
        GET_GOOD: function GET_GOOD(state, val) {
            if (state.goods.length) {
                if (state.goods.indexOf(val) !== -1) {
                    //包含
        ...
        //设置服装
        REPLACE_DRESS: function REPLACE_DRESS(state, price) {
        ...
        shopFood: function shopFood(state, name) {
            // 得到需要购买的食物
            state.foods.forEach(function (obj) {
                if (obj.name === name) {
                    state.currFood = obj;
                }
            });
        },
        UNLOCK_FOOD: function UNLOCK_FOOD(state, price) {
            state.currFood.unlock = 1;
            state.user.money = state.user.money - price;
        },
        FEED_CLICK: function FEED_CLICK(state, endDate) {
        ...
        // 获得成就方法
        checkAchievemnt: function checkAchievemnt(state, id) {

            // 寻找目标一致且未完成的成就
            var targetList = state.achievement.filter(function (obj) {
                return obj.completeTypeId === id && !obj.complete;
            });
            ...
            // 执行目标的奖励方式
            targetList.forEach(function (obj) {
        ...
        // 进食结束
        END_EAT: function END_EAT(state) {
        ...
        //每道题金币更新
        SET_GOLD: function SET_GOLD(state, val) {
            state.user.money = val.goldCount;
            state.chick.level = val.level;
        },

        //用户年级学期设置
        SET_USER_GRADE_TERM: function SET_USER_GRADE_TERM(state, val) {
    ...
    actions: {
        // 领取成就奖励
        receiveawards: function receiveawards(context, value) {
            context.commit('SAVE_GAME');
        },

        // 存档
        savegame: function savegame(context) {
            context.commit('SAVE_GAME');
        },

        // 购买商品
        shopsettle: function shopsettle(context, value) {
            context.commit("SHOP_SETTLE", value);
            context.commit('SAVE_GAME');
        },

        //设置用户年级和学期、用户id、用户名称
        setusergrade: function setusergrade(context, value) {
            context.commit('SET_USER_GRADE_TERM', value);
            context.commit('SAVE_GAME');
        },
        saveuserId: function saveuserId(context, value) {
        ...
        // 设置新的用户名
        setusername: function setusername(context, value) {
            context.commit('SET_USER_NAME', value);
            context.commit('SAVE_GAME');
        },

        // 出售物品
        sellgood: function sellgood(context, value) {
            context.commit('SELL_GOOD', value);
            context.commit('SAVE_GAME');
        },

        // 查看物品详情
        shopGood: function shopGood(context, value) {
            context.commit('SHOW_GOOD', value);
        },

        // 设置服装
        replacedress: function replacedress(context, value) {
            context.commit("REPLACE_DRESS", value);
            context.commit('SAVE_GAME');
        },

        // 解锁商品
        unlockfood: function unlockfood(context, value) {
            context.commit("UNLOCK_FOOD", value);
            context.commit('SAVE_GAME');
        },
        endeat: function endeat(context) {
...
var host = 'https://api.tk.ejex.net/renbo/public'; //写自己的域名
var myHost = 'https://api.zx.ejex.net';
...
function request_a(url, method, data) {
  var header = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_color__ = __webpack_require__(152);
...
module.exports = {
    'achievements': [{
        ...
        oncomplete: function oncomplete(state, achievement) {
...
module.exports = {
    'subjects': [{
        ...
        list: [{
            id: 10011,
            name: '知识感知',
            img: '/static/images/subject/BA1.jpg',
            learning: 0,
            difficulty: {
                "1": 9,
                "2": 1,
            ...
            id: 10022,
            name: '知识巩固',
            img: '/static/images/subject/BB2.jpg',
            learning: 0,
            difficulty: {
                "1": 3,
                "2": 5,
            ...
            id: 10031,
            name: '知识运用',
            img: '/static/images/subject/BC1.jpg',
            learning: 0,
            difficulty: {
                "1": 1,
                "2": 5,
            ...
            id: 10032,
            name: '知识拔高',
            img: '/static/images/subject/BC2.jpg',
            learning: 0,
            difficulty: {
                "1": 0,
                "2": 3,
            ...
            id: 10041,
            name: '知识挑战',
            img: '/static/images/subject/BD1.jpg',
            learning: 0,
            difficulty: {
                "1": 0,
                "2": 1,
        ...
        list: [{
            id: 10011,
            name: '知识感知',
            img: '/static/images/subject/AA1.jpg',
            learning: 0
        }, {
            id: 10012,
            name: '知识理解',
        ...
        list: [{
            id: 10011,
            name: '知识感知',
            img: '/static/images/subject/yy.jpg',
            learning: 0
        }, {
            id: 10012,
            name: '知识理解',
